...
export type TeacherManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  portfolio_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** Any other value that exists and is not equal to the given value. */
  ...
  /** All values that are not contained in given list. */
  portfolio_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, challenge?: { __typename?: 'Challenge', url: string } | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string, portfolio: string } | null } | null };
